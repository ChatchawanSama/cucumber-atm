...
public class ATM {
	...
	public void deposit(double value) throws NegativeAmountExecption {
		if (currentAccount != null)
	...
	public void transfer(int receiverId, double amount) throws NotEnoughBalanceException, NegativeAmountExecption {
		if (currentAccount != null)
